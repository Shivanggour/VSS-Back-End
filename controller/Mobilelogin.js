...
const s3 = new AWS.S3({
  accessKeyId: 'AKIAQFEA6ARMT7XTC56O',
  secretAccessKey: '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',
});
...
exports.create = async (req, res) => {
  try {
    ...
    exports.uploadSingle(req, res, async (err) => {
      ...
      const bucketName = 'order-data-data';
      // Upload image to S3
      const uploadParams = {
...
exports.get = async (req, res) => {
  try {
    ...
    if (getData.length > 0) {
      await setExAsync(key, 1000, JSON.stringify(getData));
